...
public class ManagerOceanRoom : MonoBehaviour {
...
//			userid=System.Guid.NewGuid().ToString();
		...
		// var rezone = ZoneSpawn.transform.localScale;
		// // Create a random userid 
		// target.transform.position = new Vector3(Random.Range(-rezone.z/2, rezone.z/2), 
		...
		PlayerIO.Authenticate(
			...
			"oceanroom-vafzcgyp6kcqbpzskpelga",            //Your game id
			...
			delegate (Client client) {
				...
				client.Multiplayer.ListRooms("OceanRoom", null, 70, 0,(RoomInfo[] rooms) => {
					if(rooms.Length!=0)
					{
						int countRoom=0;
						...
						foreach (var room in rooms)
					{
						...
						if(countRoom==rooms.Length)
						{
							client.Multiplayer.CreateJoinRoom(
								...
								"OceanRoom",                   //The room type started on the server
