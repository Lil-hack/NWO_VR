...
public class ManaggerBossRoom : MonoBehaviour {
	...
	public Animator bossAnimatorl;
	public BoxCollider boxcolBoss;
	...
	void Start() {
		...
		PlayerIO.Authenticate(
			...
			"bossroomzero-yp5l8vstes3f98t6sz0bq",            //Your game id
			...
			delegate (Client client) {
				...
				client.Multiplayer.ListRooms("BossTypeRoom", null, 70, 0,(RoomInfo[] rooms) => {
					if(rooms.Length!=0)
					{
						int countRoom=0;
						...
						if(countRoom==rooms.Length)
						{
							client.Multiplayer.CreateJoinRoom(
								...
								"BossTypeRoom",                   //The room type started on the server
